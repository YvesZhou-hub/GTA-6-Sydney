...
### v0.5.0：Windows 最终 EXE 验收通过

2026-09-19（悉尼时间），[Windows 云端运行 35434757278](https://github.com/YvesZhou-hub/GTA-6-Sydney/actions/runs/35434757278) 完成。运行与构建提交均为 `9c59e84c6e16e571c097bd25372ac36316b60a8b`（发布标签 `v0.5.0-preview.1` 指向同一提交），引擎为 Godot `4.7.2.stable.official.ed1daf0bf`。发布后下载原始报告与校验和逐项核对。

| 项目 | 实际结果 |
| --- | --- |
| 下载包 | `Harbourlife-Windows-x86_64.zip`，105,158,490 字节 |
| 包与源码 | 包检查 23/23；436 个游戏文件与同版 Mac 构建清单逐一匹配；AMD64 PE32+、外部 PCK 与 ZIP CRC 通过 |
...
| 边界 | Windows `--headless`，没有 Windows 截图；未测 Windows 显卡画面、声音、实体键鼠与手柄；战斗手感、港区限时求助、街上人车、主线与 HUD 的原生检查只在 Mac 上运行 |

| 文件 | SHA-256 |
| --- | --- |
| Windows ZIP | `b838f682017e1396ac9c6a09890d919d102541bb9e9051c3288235aed44e7aa2` |

[原始 Windows 报告](evidence/v050-windows/windows-validation.json) · [原始校验和](evidence/v050-windows/Windows-SHA256SUMS.txt)。同版 [Mac 验收](evidence/v050-app/native-index.json)另外通过 365/365 项原生检查。
