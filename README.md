...
九类载具包括超跑、运动摩托、反重力平衡车、豪华快艇、多层游艇、滑翔伞、滑翔机、直升机和大型双发客机。超跑参考 Revuelto，摩托参考 S 1000 RR，客机采用 787-9 的体量与主要特征，两种船分别参考 Rivamare 与 90 Ocean。模型包含轮胎轮毂、灯组、玻璃、发动机、甲板与座舱细节，采用原创程序化几何，不是厂商 CAD 或照片级扫描。[车辆和飞机参考](docs/VEHICLE_REFERENCE.md) · [新航空模型参考](docs/AIR_VEHICLE_REFERENCE.md) · [船艇参考](docs/BOAT_REFERENCE.md)
