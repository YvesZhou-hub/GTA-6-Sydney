extends RefCounted
## Shared, rounded yellow creature geometry. All five silhouettes use one palette.
...
static func _material(key: String) -> StandardMaterial3D:
	...
	var colors := {"yellow":Color("ffcf35"),"belly":Color("ffeaa1"),"white":Color("fffdf1"),"black":Color("202a2a"),"orange":Color("e99a25"),"strap":Color("5c4632"),"warning":Color(1.0,.19,.06,.82),"health":Color("72ebae"),"bar":Color("253932"),"hurt":Color("fff9dc")}
...
static func build(parent: Node3D, kind: String) -> Dictionary:
	...
	return {"root":visual,"body":body,"head":head,"tail":tail,"arms":arms,"feet":feet,"kind":kind}
